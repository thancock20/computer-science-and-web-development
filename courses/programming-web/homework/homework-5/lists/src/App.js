...
class App extends Component {
  ...
  handleAddList(s) {
      ...
      this.setState({lists: this.state.lists.concat(s), items: Object.assign({}, this.state.items, {[s]: []})});
  }
  ...
  handleAddItem(s) {
      // Implement this function!
      this.setState({items: Object.assign({}, this.state.items, {[s.id]: this.state.items[s.id].concat({name: s.text})})});
  }
