...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname 10-parameterization) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(check-expect (map2 string-length (list "a" "hi" "man" "cool")) (list 1 2 3 4))
...
(check-expect (filter2 false? (list true false true false false true)) (list false false false))
